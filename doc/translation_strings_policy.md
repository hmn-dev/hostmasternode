...
This document provides guidelines for internationalization of the Hostmasternode Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hostmasternode_en.ts` remains unchanged.

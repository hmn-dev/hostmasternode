...
This mechanism has been integrated into Bitcore-Node-Hostmasternode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hostmasternodepay/insight-api-hostmasternode#web-socket-api](https://github.com/hostmasternodepay/insight-api-hostmasternode#web-socket-api)
* API: [https://github.com/hostmasternodepay/insight-api-hostmasternode#instantsend-transactions](https://github.com/hostmasternodepay/insight-api-hostmasternode#instantsend-transactions)
...
By default, the Hostmasternode Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Hostmasternode Core daemon:

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s hostmasternode-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hostmasternode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hostmasternode transaction") + "\n" +
              "  hostmasternode-tx [options] -create [commands]   " + _("Create hex-encoded hostmasternode transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hostmasternode transaction

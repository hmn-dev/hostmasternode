    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  hostmasternode-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Hostmasternode in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 HMN, 0.1 HMN, 1 HMN and 10 HMN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://hostmasternodepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://hostmasternodepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);

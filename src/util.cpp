...
const char * const BITCOIN_PID_FILENAME = "hostmasternode.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Hostmasternode";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Hostmasternode";
#else
    // Unix
    return pathRet / ".hostmasternode";
#endif
#endif
}

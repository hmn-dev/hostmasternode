...
//! These need to be macros, as clientversion.cpp's and hostmasternode*-res.rc's voodoo requires it
...
/**
 * hostmasternoded-res.rc includes this file, but it cannot cope with real c++ code.

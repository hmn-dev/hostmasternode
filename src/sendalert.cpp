...
2. run hostmasternoded with -printalert or -sendalert like this:
   /path/to/hostmasternoded -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.hostmasternode.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Hostmasternode Core:0.12.0.58/"));

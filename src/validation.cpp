...
#if defined(NDEBUG)
# error "Hostmasternode cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Hostmasternode Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s HMN additional fees, %d delta bytes\n",
